      ...
      <Tabs defaultValue="sectors" className="space-y-6">
        ...
        <TabsContent value="sectors" className="space-y-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <Card>
              <CardHeader>
                <CardTitle>Sector Performance (30D)</CardTitle>
              </CardHeader>
              <CardContent>
              ...
              <CardContent>
                <div className="space-y-4">
                  {economicIndicators.map((indicator) => (
                    <div key={indicator.name} className="flex items-center justify-between p-3 rounded-lg border border-border">
                      <div>
        ...
        <TabsContent value="signals" className="space-y-6">
          <Card>
            <CardHeader>
              <CardTitle>Market Sentiment Signals</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="space-y-6">
